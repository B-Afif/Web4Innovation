...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="index.html">Consulter mes projets</a>
                    </li>
                    <li>
                        <a href="candidature.html">Deposer un projet</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Consulter mes projets
                    <small>Subheading</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.html">Home</a>
                    </li>
                    <li class="active">Consulter mes projets</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
